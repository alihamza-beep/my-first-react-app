  ...
  return (
    <footer className="bg-white text-dark mt-5 pt-2 border-top">
      ...
      <section className="container pb-5">
        <div className="row g-5 justify-content-between">
          ...
          <div className="col-12 col-lg-4">
            <h1 className="footer-logo-main mb-4" onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>
            ...
            <p className="text-muted pe-lg-5 mb-4" style={{ fontSize: '13px', lineHeight: '2.2', textAlign: 'justify' }}>
              ...
              of traditional craftsmanship and contemporary minimalism.
            </p>
      ...
      <style>{`
        ...
        .luxury-heading { font-family: 'Playfair Display', serif; font-weight: 700; font-size: 2.2rem; letter-spacing: -1px; }
        .footer-logo-main { font-family: 'Playfair Display', serif; font-weight: 900; font-size: 2.5rem; letter-spacing: 10px; color: #000; text-transform: uppercase; cursor: pointer; }
        .nav-title { font-weight: 700; text-transform: uppercase; font-size: 11px; letter-spacing: 2.5px; margin-bottom: 30px; color: #111; }
        .footer-nav-list li { margin-bottom: 18px; }
        .footer-nav-list a { color: #888; text-decoration: none; font-size: 12px; transition: all 0.4s; }
        .footer-nav-list a:hover { color: #000; letter-spacing: 1px; }
        .social-pill { color: #000; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; border: 1px solid #eee; border-radius: 50%; transition: 0.3s; }
        .social-pill:hover { background: #000; color: #fff; transform: translateY(-5px); }
        .secure-badge { background: #fff; border: 1px solid #000; transition: 0.3s ease; }
        .secure-badge:hover { background: #000; color: #fff; }
        .method-wrap { cursor: pointer; filter: grayscale(100%); opacity: 0.4; transition: 0.4s; }
        .method-wrap:hover { filter: grayscale(0%); opacity: 1; transform: scale(1.1); }
      `}</style>
    </footer>
  );
}