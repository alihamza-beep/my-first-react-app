...
function AccessoriesSubPage({ title = "Bags" }) {
  ...
  // Professional images pool for Bags
  const imagesPool = [
    "https://images.unsplash.com/photo-1584917089215-991f4cb7bb2e?q=80&w=400",
    "https://images.unsplash.com/photo-1591561954557-26941169b49e?q=80&w=400",
    "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=400",
    "https://images.unsplash.com/photo-1566150905458-1bf1fd15dcb4?q=80&w=400"
  ];

  // Generating products dynamically based on the "Bags" title
  const initialProducts = useMemo(() => Array.from({ length: 12 }).map((_, i) => ({
    id: `bags-${i}`,
    name: `Luxury Handbag - Signature Ed. ${i + 1}`,
    price: 8500 + (i * 500), 
  ...
  return (
    <div className="container-fluid px-4 mt-2 pt-2 bg-white">
      {/* Dynamic Header Section for Bags */}
