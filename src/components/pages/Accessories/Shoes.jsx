...
function AccessoriesSubPage({ title = "Shoes" }) {
  ...
  // Professional images pool for Shoes (Heels, Flats, Loafers)
  const imagesPool = [
    ...
    "https://images.unsplash.com/photo-1603808033192-082d6919d3e1?q=80&w=400",
    "https://images.unsplash.com/photo-1535043934128-cf0b28d52f95?q=80&w=400"
  ];

  // Generating products based on the "Shoes" title
  const initialProducts = useMemo(() => Array.from({ length: 12 }).map((_, i) => ({
    id: `shoes-${i}`,
    name: `${title} - Signature Step ${i + 1}`,
    price: 3500 + (i * 450), 
  ...
  return (
    <div className="container-fluid px-4 mt-2 pt-2 bg-white">
      {/* Dynamic Header Section for Shoes */}
