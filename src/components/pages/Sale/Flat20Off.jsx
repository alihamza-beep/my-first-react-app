...
function Flat20Off() {
  // 1. Image pool from your folder structure
  const imagesPool = [
  ...
  return (
    <div className="container-fluid px-4 mt-2 pt-2 bg-white">
      ...
      <div className="text-center mb-5 mt-4">
        <h2 className="fw-bold tracking-[0.3em] text-uppercase font-serif" style={{ fontSize: '30px' }}>FLAT 20% OFF</h2>
        <p className="text-muted" style={{ fontSize: '11px', letterSpacing: '2px' }}>DISCOVER WINTER ESSENTIALS AT SPECIAL PRICES</p>
        <div className="mx-auto bg-black mt-2" style={{ width: '40px', height: '2px' }}></div>
      </div>
      ...
      <style>{`
        ...
        .sale-btn:hover { background-color: #444 !important; letter-spacing: 2px !important; }
