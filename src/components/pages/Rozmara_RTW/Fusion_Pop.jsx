...
function FusionPop() {
  ...
  // Fusion Pop specific images pool
  const imagesPool = [
  ...
  // Generating products for "Fusion Pop"
  const initialProducts = useMemo(() => Array.from({ length: 8 }).map((_, i) => ({
    id: `fusion-pop-${i}`,
    name: `Fusion Pop - Trend Article ${i + 1}`,
    price: 3950 + (i * 150), 
  ...
  return (
    <div className="container-fluid px-4 mt-2 pt-2 bg-white">
      {/* Header Section - Now says Fusion Pop */}
      <div className="text-center mb-4 mt-4">
        <h2 className="fw-bold tracking-[0.4em] text-uppercase font-serif" style={{ fontSize: '28px' }}>Fusion Pop</h2>
        <div className="mx-auto bg-dark mt-2 mb-2" style={{ width: '40px', height: '2px' }}></div>
        <p className="text-muted small text-uppercase tracking-widest" style={{ fontSize: '10px' }}>Rozmara RTW / Fusion Pop</p>
      </div>
      ...
      <div className="d-flex justify-content-between align-items-center py-3 mb-4 border-top border-bottom">
        ...
        <div className="d-flex align-items-center">
          ...
          >
            <option value="featured">New Trends</option>
      ...
      <style>{`
        ...
        .sale-btn { transition: 0.4s ease; border: 1px solid #000; }
